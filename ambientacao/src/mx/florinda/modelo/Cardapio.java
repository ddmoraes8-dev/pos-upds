...
public class Cardapio {
    ...
    public Cardapio() {
        ...
        ItemCardapioIsento item4 = new ItemCardapioIsento(4L, "Pipoca do Quico",
        ...
        ItemCardapioIsento item6 = new ItemCardapioIsento(6L, "Churros do Chaves",
                "Churros recheados com doce de leite, clássicos e irresistíveis.", 4.99, CategoriaCardapio.SOBREMESAS);
        item6.setPromocao(3.99);

        ItemCardapioIsento item7 = new ItemCardapioIsento(7L, "Tacos de Carnitas",
    ...
    public ItemCardapio getItemPorId(long id) {
        return itens[((int) id) - 1];
    }
